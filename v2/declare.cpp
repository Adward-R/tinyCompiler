...
void lwd::stprint(SimpleType s) {
	...
	bool type_decl::semanticCheck(name_list *ids, int scope, int type) {
		/*
			@type: 1 for type definition, 2 for variable definition
		*/
		bool temp1 = true;
		if (ids->child1 != NULL) {
			temp1 = semanticCheck(ids->child1, scope, type);
		}
...
/*******************************/
	...
	bool name_list::semanticCheck(int scope) { 
		bool temp1 = true;
		if (child1) {
			temp1 = child1->semanticCheck(scope);
		}
...
/**
*  ----------------#expression_list	 #expression  Yang
*  expr term   Adward
*  ---------------#factor 	An
**/
